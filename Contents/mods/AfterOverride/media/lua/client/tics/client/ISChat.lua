...
ISChat.allChatStreams[12] = { name = 'enviroment', command = '/enviroment ', shortCommand = '/en ', tabID = 1, forget = true }
ISChat.allChatStreams[13] = { name = 'enviromentall', command = '/enviromentall ', shortCommand = '/ena ', tabID = 1, forget = true }
...
local function ProcessChatCommand(stream, command)
    ...
    elseif stream.name == 'enviroment' then
        ClientSend.sendChatMessage(command, language, playerColor, 'general', pitch, false)
    elseif stream.name == 'enviromentall' then
        ClientSend.sendChatMessage(command, language, playerColor, 'general', pitch, false)
    else
...
local MessageTypeToColor = {
    ...
    ['admin'] = { 230, 130, 111 },
    ['ooc'] = { 146, 255, 148 },
    ['enviroment'] = { 255, 200, 0 },
    ['enviromentall'] = { 255, 200, 0 },
}
...
local MessageTypeToVerb = {
    ['whisper'] = ' fýsýldayarak, ',
    ['low'] = ' sessizce diyor ki, ',
    ['say'] = ' diyor ki, ',
    ['yell'] = ' baðýrarak, ',
    ['radio'] = ' telsizden konuþuyor, ',
    ['scriptedRadio'] = 'telsizden konuþuyor, ',
    ['pm'] = ' ',
    ['faction'] = ' ',
    ['safehouse'] = ' ',
    ['general'] = ' ',
